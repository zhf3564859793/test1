...
from torch_geometric.utils import to_networkx#可视化网络
import numpy as np
import pandas as pd
...
def main():
    ...
    #随机选取ddi图中128个节点作为靶点
    badian=np.random.choice(4267, 256, replace=False)
    ...
    predictor = LinkPredictor(args.out_channels, args.hidden_channels, 1,
    ...
    for run in range(args.runs):
        ...
        optimizer = torch.optim.Adam(
            list(model.parameters()) + list(emb.parameters()) +list(emb_ea.parameters()) +
